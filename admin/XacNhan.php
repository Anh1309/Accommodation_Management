...
<div class="container-fluid">
    <div class="col-md-2">
        <ul class="nav nav-pills nav-stacked" >
            ...
            <li role="presentation" class="active"><a href="XacNhan.php">Xác nhận</a></li>
    ...
    <div class ="container-fluid">
        ...
        <div class="col-md-8" style="height: 500px  ;overflow:auto;">
            ...
            $sql = "select * from nhatro where XacNhan = 0";
            ...
            while($row = mysql_fetch_array($result)){
                ...
                <div class="row" style="background-color: #2e6da4;margin-bottom:10px; margin-right: 10px">
                    ...
                    <div class= "post-infor col-md-9	">
                       ...
                       <form action="xulyXacNhan.php?MaNT=<?php echo $row['MaNT']?>" method="POST">
                        <a href="ChiTietNhatro.php?MaNT=<?php echo $row["MaNT"]; ?>">
                            <h1><?php echo $row['TieuDe'];?></h1>
                        </a>
                        <p><?php echo $row["MoTa"]; ?> </p>

                          <button type="submit" class="btn btn-default" name="submit" id="edit" style="align: left; margin:5px">Xác nhận</button>
                          <button type="submit" class="btn btn-default" name="khongxacnhan" style="align: left; margin:5px">Không xác nhận</button>
                        </form>
                    </div>
                </div>
