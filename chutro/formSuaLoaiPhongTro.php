...
<div class="container-fluid">
    ...
    <div class ="container-fluid">
        ...
        <div class="col-md-8">
            ...
            <form name="formSuaLoaiPhongTro" method="POST" action="xulySuaLoaiPhongTro.php?MaLPT=<?php echo $MaLPT; ?>">
                <div class="form-group">
                    <label>Tên loại phòng trọ</label>
                    <input type="text" name= "tenloaiphong" class="form-control" value= <?php echo $row['TenLPT']; ?> >
                ...
                <div class="form-group">
                    ...
                    <a href="ChiTietLoaiPhong.php">
                        <button type="submit" name="delete" class="btn btn-default" style="margin-top: 10px; background: #2e6da4">Hủy</button>
                    </a>
            </form>
        </div>
